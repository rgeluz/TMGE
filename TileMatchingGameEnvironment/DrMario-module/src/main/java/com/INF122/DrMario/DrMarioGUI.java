...
public class DrMarioGUI {
    ...
    public ImageView setUpGameLogo() {
        ...
        try{
        	imageDRMLogo = new Image(new FileInputStream("DrMario-module/resources/DrMarioLogo.png"));
    ...
    public Scene generateMultiplayerScene(String player1Name, String player2Name) {
      ...
      //Player 1
        ...
        Label pc2Name = new Label(player2Name);
        pc2Name.setPadding(new Insets(10, 10, 10, 10));
        gridPaneCenter.add(pc2Name, 1,17);
